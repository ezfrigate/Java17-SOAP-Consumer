...
@XmlRootElement(name = "StartConfigurationFromReferencePermissiveModeWithSpecificBehaviour")
public class StartConfigurationFromReferencePermissiveModeWithSpecificBehaviour {
    ...
    @XmlElementRef(name = "reference", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
